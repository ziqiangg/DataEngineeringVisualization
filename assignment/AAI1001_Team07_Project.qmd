...
subtitle: "AAI1001 Team 7 Enhanced Data Visualisation Project"
author:
...
analysis_df <- data.frame(
  Aspect = c("Data Quality", "Time Scope", "Context", "Interactivity", "Demographic Detail", "Design"),
  Strengths = c(
...
kable(analysis_df, 
      caption = "Comprehensive Analysis of Original Visualisation vs Our Improvements",
      booktabs = TRUE) %>%
...
Recent research by [Tan (2024)](https://www.straitstimes.com/singapore/why-the-fertility-rate-doesn-t-capture-socio-economic-or-cultural-trends) critiques oversimplified fertility visualisations, emphasising the need to **incorporate socioeconomic and cultural factors** that drive rising singlehood and delayed marriage patterns.
...
data_sources <- data.frame(
  ...
  Time_Period = c("1990-2022", "1990-2022", "1990-2022"),
  ...
  Records = c("17 time series", "~2,500 records", "~2,500 records")
)
...
```{r outlier-viz, fig.cap="Fertility Rate Outliers by Age Group"}
