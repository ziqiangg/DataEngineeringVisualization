...
2. **Limited range**: The graph only displays data from 2019-2023. This is not a wide enough range to make conclusive statements.
...
4. **Static visualisation**: The original visualisation lacks depth and interactive features that would otherwise allow the user to better understand the graphs. The static nature does not allow the user to hover or click on data points to gain more information.


# Suggested Improvements

1. **Include data validation**: Add comprehensive data validation along with outlier analysis. This aims to ensure the accuracy and reliability of the data presented. 
